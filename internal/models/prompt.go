...
const (
	...
	generatePromptInstruction = "Please write a commit message for these git changes, "
)
...
func getCommitGeneratePrompt(generateMsg string) string {
	return generatePromptInstruction + generateMsg
}

func getCommitRefinePrompt(refineMsg string) string {
